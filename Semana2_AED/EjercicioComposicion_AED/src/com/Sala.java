...
public class Sala {
	...
	public Sala(String color, int numVentanas, int numPuertas, int numTomacorrientes, boolean amueblada,
			double medida) {
		super();
		this.color = color;
	...
	public String toString() {
		return "Sala [color=" + color + ", NumVentanas=" + NumVentanas + ", NumPuertas=" + NumPuertas
