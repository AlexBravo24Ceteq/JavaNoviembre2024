...
public class ColeccionesMap {
	...
	public static void main(String[] args) {
		...
		// Es decir, la clave actua como un identificador único para cada elemento a
		// almacenar (ID)
		...
		// Imprimir en pantalla un sólo valor almacenado en una determinada clave:
		System.out.println(usuarios.get(2));

		// Eliminar un elemento de nuestro HasMap:
		usuarios.remove(3);
